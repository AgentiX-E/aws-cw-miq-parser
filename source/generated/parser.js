...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { Query: peg$parseQuery, SelectClause: peg$parseSelectClause, FromClause: peg$parseFromClause, WhereClause: peg$parseWhereClause, GroupByClause: peg$parseGroupByClause, OrderByClause: peg$parseOrderByClause, LimitClause: peg$parseLimitClause };
  ...
  var peg$c28 = "and";
  var peg$c29 = "or";
  var peg$c30 = "current_account_id";
  var peg$c31 = "group";
  var peg$c32 = "by";
  var peg$c33 = "order";
  var peg$c34 = "desc";
  ...
  var peg$e7 = peg$literalExpectation("AVG", true);
  ...
  var peg$e11 = peg$literalExpectation("SUM", true);
  ...
  var peg$e18 = peg$literalExpectation("AWS.AccountId", true);
  ...
  var peg$e30 = peg$literalExpectation("SELECT", true);
  var peg$e31 = peg$literalExpectation("(", false);
  var peg$e32 = peg$literalExpectation(")", false);
  var peg$e33 = peg$literalExpectation("FROM", true);
  var peg$e34 = peg$literalExpectation("SCHEMA", true);
  ...
  var peg$e39 = peg$literalExpectation("CURRENT_ACCOUNT_ID", true);
  var peg$e40 = peg$literalExpectation("GROUP", true);
  var peg$e41 = peg$literalExpectation("BY", true);
  var peg$e42 = peg$literalExpectation("ORDER", true);
  var peg$e43 = peg$literalExpectation("DESC", true);
  var peg$e44 = peg$literalExpectation("ASC", true);
  var peg$e45 = peg$literalExpectation("LIMIT", true);

  var peg$f0 = function() { collectedComments.push({ type: 'LineComment', text: text(), location: location() }); };
  var peg$f1 = function() { collectedComments.push({ type: 'BlockComment', text: text(), location: location() }); };
  var peg$f2 = function(name) {
      return text().toUpperCase();
    };
  var peg$f3 = function() { return expected('one of AVG, COUNT, MAX, MIN, SUM (aggregation function)'); };
  ...
  var peg$f8 = function() { return { isTag: false, name: 'AWS.AccountId' }; };
  var peg$f9 = function(id) { return { isTag: false, name: id }; };
  ...
  var peg$f20 = function(ns) { return ns.join(''); };
  var peg$f21 = function(ns) { return ns; };
  var peg$f22 = function() { return '"'; };
  var peg$f23 = function(dim) { return dim.join(''); };
  var peg$f24 = function(dim) { return dim; };
  var peg$f25 = function(func, metric) {
      return {
        type: 'SelectClause',
        function: func,
        metricName: metric,
  ...
  var peg$f28 = function(ns, dim) { return dim; };
  var peg$f29 = function(ns, dims) {
      return {
        type: 'SchemaFrom',
        namespace: ns,
        dimensions: dims,
  ...
  var peg$f30 = function(first, op, cond) { return { op, cond }; };
  ...
  var peg$f33 = function() { return 'OR'; };
  var peg$f34 = function(label, op, val) {
      return {
        type: 'WhereCondition',
        labelKey: label.name,
        operator: op,
  ...
  var peg$f35 = function() { return 'CURRENT_ACCOUNT_ID()'; };
  ...
  var peg$f37 = function(key) { return key; };
  var peg$f38 = function(func) { return 'ASC'; };
  var peg$f39 = function(func, direction) {
      return {
        type: 'OrderByClause',
        function: func,
  ...
  var peg$f40 = function() { return 'DESC'; };
  var peg$f41 = function() { return 'ASC'; };
  ...
  var peg$f43 = function(select, from, where, groupBy, orderBy, limit) {
      const result = {
  ...
  function peg$parseQuotedIdentifier() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$parseQuotedIdentifierChar();
      while (s3 !== peg$FAILED) {
        s2.push(s3);
        s3 = peg$parseQuotedIdentifierChar();
      }
  ...
  function peg$parseQuotedIdentifierChar() {
    var s0, s1;
  ...
  function peg$parseTagIdentifier() {
    var s0, s1, s2, s3;
  ...
  function peg$parseNamespaceValue() {
    var s0, s1, s2, s3;
  ...
  function peg$parseNamespaceChar() {
    var s0, s1;
  ...
  function peg$parseDimensionName() {
    var s0, s1, s2, s3;
  ...
  function peg$parseFromClause() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      s3 = peg$parseSchemaSource();
      if (s3 === peg$FAILED) {
        s3 = peg$parseNamespaceSource();
      }
      if (s3 !== peg$FAILED) {
        s4 = peg$parse_();
        peg$savedPos = s0;
  ...
  function peg$parseNamespaceSource() {
    var s0, s1;

    s0 = peg$currPos;
    s1 = peg$parseNamespaceValue();
    if (s1 !== peg$FAILED) {
      peg$savedPos = s0;
      s1 = peg$f27(s1);
    }
  ...
  function peg$parseSchemaSource() {
  ...
  function peg$parseWhereClause() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        s5 = [];
        s6 = peg$currPos;
        s7 = peg$parseLogicalConjunction();
        if (s7 !== peg$FAILED) {
          s8 = peg$parse_();
  ...
  function peg$parseGroupByClause() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        s4 = peg$parse_();
        s5 = peg$parseLabelKey();
        if (s5 !== peg$FAILED) {
          s6 = peg$parse_();
          s7 = [];
          s8 = peg$parseGroupByRest();
          while (s8 !== peg$FAILED) {
            s7.push(s8);
            s8 = peg$parseGroupByRest();
          }
